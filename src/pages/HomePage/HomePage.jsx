            ...
            <div className="homepage">
                <div className="nav">
                    ...
                    <div className="nav__container">
                        <div>
                            <img className="nav__container--icon" src={timerIcon} alt="timer"></img>
                        </div>
                        <div>
                            <img className="nav__container--icon" src={videoIcon} alt="video"></img>
                        </div>
                        <div>
                            <img className="nav__container--icon" src={micIcon} alt="mic"></img>
                        </div>
                        <div>
                            <img className="nav__container--icon" src={shareIcon} alt="share"></img>
                        </div>
                        <div>
                        ...
                        <div>
                            <img className="nav__container--icon" src={handIcon} alt="hand"></img>
                        </div>
                        <div>
                            <img className="nav__container--icon" src={chatIcon} alt="chat"></img>
                        </div>
                        <div>
                            <img
                                className="nav__container--icon"
                        ...
                        <div>
                            <img className="nav__container--icon" src={endIcon} alt="end"></img>
                        </div>
                    </div>
                </div>
            </div>
